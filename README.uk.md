...
>
> - Встановіть [Node.js](https://nodejs.org), якщо його ще немає, і в терміналі (PowerShell) виконайте:
>   ```
>   npm install -g @anthropic-ai/claude-code
>   claude login
>   ```
> - Увійдіть тим самим акаунтом, яким користуєтесь у Claude Desktop або claude.ai. Далі реально користуватись Claude Code не потрібно - ClaudeQuota сам підхопить цей логін.
>
