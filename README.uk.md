...
>
> 1. Натисніть **Win**, введіть `PowerShell`, натисніть Enter, щоб відкрити термінал.
> 2. Виконайте:
>    ```
>    winget install Anthropic.ClaudeCode
>    ```
> 3. Закрийте це вікно і відкрийте новий PowerShell так само (Windows потребує свіжий термінал, щоб побачити встановлене).
> 4. Виконайте:
>    ```
>    claude auth login
>    ```
