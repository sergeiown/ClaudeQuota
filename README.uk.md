...
>
> 1. Натисніть **Win**, введіть `PowerShell`, клацніть правою кнопкою на результаті й оберіть **Запуск від імені адміністратора** (потрібно для встановлення Node.js на весь комп'ютер) - підтвердіть запит Windows, що з'явиться.
> 2. Виконайте:
>    ```
>    winget install OpenJS.NodeJS.LTS
>    ```
> 3. Закрийте це вікно і відкрийте новий PowerShell від імені адміністратора так само (Windows потребує свіжий термінал, щоб побачити встановлене).
> 4. Виконайте:
>    ```
...
>    Ось як це виглядає:
>
>    <img src="docs/setup-terminal.png" width="500" alt="Вивід терміналу для npm install і claude auth login">
>
>    Відкриється вкладка браузера для входу - після підтвердження вона покаже це, і вкладку можна закрити:
>
