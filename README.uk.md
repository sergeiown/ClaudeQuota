...
- **Шкали** (за замовчуванням): дві шкали заповнення - одна для 5-годинного вікна, друга для тижневого.
- **Кола**: ті самі два значення у вигляді концентричних кіл-індикаторів - більше зовнішнє коло - 5-годинне вікно, менше внутрішнє - тижневе.

Точний відсоток і час оновлення - у тултипі при наведенні, незалежно від стилю.

Колір "порожньої" частини кожної шкали/кола фіксований і лише позначає, яке це вікно - синій для 5-годинного, фіолетовий для тижневого - він не змінюється залежно від використання. Колір заповненої частини залежить від того, наскільки близько це вікно до свого ліміту: зелений до 50%, жовтий від 51% до 80%, червоний від 81% і вище. Пороги однакові для обох.
...
Правий клік на іконці показує: запуск разом із Windows (увімкнено за замовчуванням після встановлення, можна перемкнути), стиль відображення (перемикає шкали/кола, зберігається між запусками), відкрити лог, про програму, вихід.
