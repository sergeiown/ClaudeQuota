...
> **Не бачите жодних цифр?** ClaudeQuota читає використання з локального файлу логіну, який створює тільки вкладка **Code** в Claude Desktop або Claude Code CLI - не сам claude.ai.
>
> - **Користуєтесь Claude Desktop?** Перемкніться на вкладку **Code** (зверху вікна, поруч із *Chat and Cowork*). Просто відкрити вкладку недостатньо - введіть будь-що в полі внизу (хоч "привіт") і натисніть Enter, щоб реально почати сесію: саме цей крок створює файл логіну. Далі можна одразу повернутись у Chat - Code більше не знадобиться.
>
>   <img src="docs/claude-desktop-code-tab.png" width="280" alt="Вкладки Chat and Cowork / Code в Claude Desktop">
> - **Користуєтесь тільки claude.ai в браузері?** Це не запрацює з ClaudeQuota, і принципово не може - у браузера немає доступу до файлів вашого ПК. Встановіть [Claude Desktop](https://claude.ai/download), увійдіть один раз через вкладку Code - і ClaudeQuota підхопить це автоматично.
>
> Іконки в треї теж ніде не видно? Windows інколи ховає нові іконки - перевірте стрілочку **^** біля годинника.
