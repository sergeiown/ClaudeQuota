...
>
> - **Користуєтесь Claude Desktop?** Перемкніться на вкладку **Code** (зверху вікна, поруч із *Chat and Cowork*) і за потреби увійдіть там один раз. Далі можна одразу повернутись у Chat - Code більше не знадобиться.
>
