...
const CASES = [
  ...
  { name: 'bars-nodata-awaiting-code', style: 'bars', isDark: false, numerator: 0, denominator: 0, lineOne: 'Not signed in yet.', lineTwo: '', hasData: false, actionMode: 'input', actionLabel: 'Paste the code from the browser', actionCancelable: true },
...
app.whenReady().then(async () => {
  ...
  for (const c of CASES) {
    const args = {
      ...
      actionCancelable: c.actionCancelable || false,
    };
